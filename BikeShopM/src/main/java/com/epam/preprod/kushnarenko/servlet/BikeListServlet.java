...
import main.java.com.epam.preprod.kushnarenko.db.Order;
...
public class BikeListServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse resp) throws ServletException, IOException {
        ...
        logger.info(String.format("Filter criteria: %s", filteringCriteria));
        ...
        logger.info(String.format("Number of pages %d", filteringCriteria.getNumberOfPages()));
    ...
    private FilteringCriteria createFilterCriteria(HttpServletRequest request) {
        ...
        try {
            ...
            fc.setDesc((Boolean.parseBoolean(request.getParameter("desc"))) ? Order.Ascending : Order.Descending);
            ...
            logger.error("Error with parsing request to FilterCriteria", e);
        }
        return fc;
    }
