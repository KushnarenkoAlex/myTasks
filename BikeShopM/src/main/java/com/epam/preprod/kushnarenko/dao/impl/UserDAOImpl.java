...
public class UserDAOImpl implements UserDAO {
    ...
    public User getEntityByEmail(String email, Connection con) {
        logger.info(String.format("Getting entity by email: %s", email));
        User user = null;
        ...
        try {
            ...
            logger.info("Executing of query " + pstmt);
            ...
            logger.error("SQL exception in getEntityByEmail", e);
        }
    ...
    public boolean userExists(String email, Connection con) {
        logger.info(String.format("checking existing of user with email %s was called", email));
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        int res = 0;
        try {
